...
def plot_3d_earthquake_globe(self):
    """Create 3D globe visualization for earthquakes"""
    if 'earthquake' not in self.individual_datasets:
        return None

    df = self.individual_datasets['earthquake']
